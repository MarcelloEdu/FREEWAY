...
BRANCO = (255, 255, 255)
PRETO = (0, 0, 0)
#importação dos arquivos externos usando caminho relativo
caminho_atual = os.path.abspath(os.path.dirname(__file__))
img_fundo_ret = os.path.join(caminho_atual, 'arquivos/estrada.jpg')
galinha_ret = os.path.join(caminho_atual, 'arquivos/galinha.png')
azul_d_ret = os.path.join(caminho_atual, 'arquivos/carro_azul_d.png')
azul_e_ret = os.path.join(caminho_atual, 'arquivos/carro_azul_e.png')
vermelho_d_ret = os.path.join(caminho_atual, 'arquivos/carro_vermelho_d.png')
vermelho_e_ret = os.path.join(caminho_atual, 'arquivos/carro_vermelho_e.png')
verde_d_ret = os.path.join(caminho_atual, 'arquivos/carro_verde_d.png')
verde_e_ret = os.path.join(caminho_atual, 'arquivos/carro_verde_e.png')
fonte_ret = os.path.join(caminho_atual, 'arquivos/quadriculada.ttf')
musica_ret = os.path.join(caminho_atual, 'arquivos/poze_80.mp3')
#nomeando os arquivos externos
