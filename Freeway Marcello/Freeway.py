...
img_fundo_ret = os.path.join(caminho_atual, 'estrada.jpg')
galinha_ret = os.path.join(caminho_atual, 'galinha.png')
azul_d_ret = os.path.join(caminho_atual, 'carro_azul_d.png')
azul_e_ret = os.path.join(caminho_atual, 'carro_azul_e.png')
vermelho_d_ret = os.path.join(caminho_atual, 'carro_vermelho_d.png')
vermelho_e_ret = os.path.join(caminho_atual, 'carro_vermelho_e.png')
verde_d_ret = os.path.join(caminho_atual, 'carro_verde_d.png')
verde_e_ret = os.path.join(caminho_atual, 'carro_verde_e.png')
fonte_ret = os.path.join(caminho_atual, 'quadriculada.ttf')
musica_ret = os.path.join(caminho_atual, 'poze_80.mp3')
